...
window.tk.call("wm", "iconphoto", window._w, PhotoImage(file = "unit converter image.png"))
...
def convert():
    try:    
        ...
        if _from.get() =="Meter" and _to.get() == "Meter":
            result = meter.meter_meter(from_entry)
            te.insert("end", result)
        elif _from.get() == "Meter" and _to.get() == "Milimeter":
            result = meter.meter_milimeter(from_entry)
            te.insert("end", result)
    ...
    #   Kilometer
        if fastfrom == "Kilometer" and fasto == "Meter":
            ...
            result = km.kilometer_kilometer(from_entry)
            te.insert("end", result)    
    ...
    #   centimeter
        if fastfrom == "Centimeter" and fasto == "Meter":
            ...
            result = cm.centimeter_kilometer(from_entry)
            te.insert("end", result)
    ...
    #   milimeter
        if fastfrom == "Milimeter" and fasto == "Meter":
            ...
            te.insert("end", result)
        elif fastfrom == "Milimeter" and fasto == "Yard":
    ...
    #   Yard
        if fastfrom == "Yard" and fasto == "Meter":
            ...
            result = yard.yard_yard(from_entry)
            te.insert("end", result)
...
# convert_frame = tk.Frame(window)
# convert_frame.place(anchor="n", relx=0.5, rely=0.65)
# convert_image = PhotoImage(file="unit converter image.png")
convert_btn = tk.Button(text="Convert", command=convert)
convert_btn.config(bg="sky blue")
convert_btn.place(x=200,y= 400)
